 ...
 *
 * @author Christian Schmidt, github@superbilk.org
 * @version 0.1
 * @package sipgateAPI_XMLRPC
 */
...
class sipgateAPI_XMLRPC {
     ...
     * Click2Dial
     *
     * Call this method to initiate a phone call! First your phone rings, when you answer, the callees phone rings.
	 ...
	 */
	 private function getClient($username, $password)
	 {
	   	if (null === $this->client) {
            ...
            // Build URL
            $this->url = "https://" . $username . ":" . $password . "@samurai.sipgate.net:443/RPC2";
